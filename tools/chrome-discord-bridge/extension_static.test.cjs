...
assert.match(serviceWorker, /localSentinelEchoFallbackUrls/);
...
assert.match(content, /localSentinelEchoFallbackUrls/);
...
assert.match(content, /function canonicalMessageEventId/);
assert.match(content, /canonicalMessageEventId\(listId\)/);
assert.match(content, /canonicalMessageEventId\(id\)/);
