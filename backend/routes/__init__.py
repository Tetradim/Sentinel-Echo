...
from .live_operations import router as live_operations_router, set_db as set_live_operations_db


def init_routes(database):
    """Initialize all routes with the database abstraction layer."""
    ...
    set_live_operations_db(database)
