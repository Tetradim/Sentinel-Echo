...
const styles = StyleSheet.create({
  ...
  stepButtonText: { color: '#7dd3fc', fontSize: 18, fontWeight: '900' },
  track: {
    flex: 1,
    height: 10,
    borderRadius: 999,
  ...
  trackFill: { height: '100%', borderRadius: 999, backgroundColor: '#0ea5e9' },
  metaRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  metaText: { color: '#64748b', fontSize: 11, fontWeight: '700' },
  valueText: { color: '#e2e8f0', fontSize: 12, fontWeight: '900' },
});
